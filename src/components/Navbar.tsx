...
function Navbar() {
    ...
    return (
        <div className='container-fluid '>
            <div className='row'>
                <div className='col-12 navbar d-flex justify-content-center align-items-center'>
                    ...
                    <div className='col-6 navInfo d-flex flex-md-row flex-column justify-content-end align-items-center '>
                        <div className='col-6  d-flex justify-content-center'>
                            <StyledLink to='mailto:Gamera@mail.com'>Gamera@mail.com</StyledLink>
                        </div>
                        <div className='col-6 d-flex justify-content-center'>
                        <span className='d-none d-md-inline'>Call Us :</span> <StyledLink className='ms-1' to='tel:123456789'>123-456-7890 </StyledLink>
                        </div>
                    </div>
