...
return (
        ...
        <div className='row'>
            <PagesHeader className="col-12 d-flex flex-column align-items-center justify-content-center">
        ...
        <div className="row mt-5 d-flex justify-content-center">
            <div className="col-10 d-flex justify-content-between p-0">
                <div className="col-3 radioBox align-self-start d-flex flex-column align-items-center">
                    ...
                    <h4 className="col-12  mt-3">Platforms </h4>
                    ...
                    <h4 className="col-12  mt-3">Sort By </h4>
                ...
                <div className='col-8 d-flex flex-wrap justify-content-center gap-2'>
                    {category === 'all' ?
                        games&& games.map((game: Games) => {
                            return <motion.div
                                ...
                                key={game.id}
                                className='col-3 '>
                                <Link onClick={()=>dispatch(setGame(game.id))} style={{color:'#ee626b',textDecoration:'none'}} to={`/game/${game.id}`} className="col-12 d-flex flex-column" key={game.id}>
                                <div className='col-12 d-flex rounded gameBox overflow-hidden'>
                                    ...
                                    <p className='col-12 text-center'>{game.title}</p>
                            </Link>
                            </motion.div>
                        })
                        : gamesData&& gamesData!==undefined? gamesData.map((game: Games) => {
                            return <motion.div
                                ...
                                key={game.id}
                                className='col-3 '>
                                <Link style={{color:'#ee626b',textDecoration:'none'}} to={`/games/${game.id}`} className="col-12 d-flex flex-column" key={game.id}>
                                <div className='col-12 d-flex rounded gameBox overflow-hidden'>
                                        <img alt='img' src={game.thumbnail} className="img-fluid h-100 w-100" />
